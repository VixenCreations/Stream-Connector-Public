...
export const ROADMAP = [
  ...
  {
    title: 'Custom OSC Touch Trigger Type',
    status: 'planned',
    date: 'TBD',
    summary:
      'A trigger that turns any incoming OSC parameter into a live-touch input - point it at your ' +
      'own avatar or world parameters, not just the built-in SPS / OGB contacts, and drive every ' +
      'output from them.',
    points: [
      'Map arbitrary OSC float or bool parameters to the live touch level',
      'Continuous (scaled) and threshold (one-shot chain) modes, matching the SPS trigger',
      'Fans out to every enabled integration: Intiface, OSC, PiShock, and the OwO vest',
    ],
  },
  {
