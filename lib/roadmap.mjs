...
export const ROADMAP = [
  ...
  },
  {
    ...
    date: 'TBD',
    summary:
      'The free Stream Connector edition returns as a public release, rebuilt on the hardened ' +
      'execution engine with the full streaming, VRChat, and hardware toolkit intact.',
    points: [
      'Public download restored for the free edition',
      'Built on the unified, fail-closed execution engine hardened across the v6 line',
      'Ships alongside the paid VixForge Haptics Nexus edition',
    ],
  },
];
...
export const FOCUS = [
  ...
  },
  {
    ...
    text: 'Widening the Buttplug command surface and known-device coverage so more hardware works out of the box.',
  },
  {
