...
const META = {
  ...
  pricing: { title: 'Pricing', description: 'Tiers and pricing for both editions (provisional, subject to change at release).', group: 'Legal', order: 1 },
  licensing: { title: 'Licensing', description: 'The two editions, their shared license model, and the paid EULA.', group: 'Legal', order: 2 },
  sla: { title: 'Service Level Agreement', description: 'Support tiers, response targets, and what is covered (local-first scope).', group: 'Legal', order: 3 },
  'terms-of-service': { title: 'Terms of Service', description: 'The rules for using the Software: acceptable use, disclaimers, and liability.', group: 'Legal', order: 4 },
  'privacy-policy': { title: 'Privacy Policy', description: 'What data the Software handles (local-first, no telemetry) and how Discord Rich Presence works.', group: 'Legal', order: 5 },
