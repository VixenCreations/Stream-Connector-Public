...
const META = {
  ...
  licensing: { title: 'Licensing', description: 'The two editions, their license models, and the paid-edition EULA.', group: 'Legal', order: 1 },
  'terms-of-service': { title: 'Terms of Service', description: 'The rules for using the Software: acceptable use, disclaimers, and liability.', group: 'Legal', order: 2 },
  'privacy-policy': { title: 'Privacy Policy', description: 'What data the Software handles (local-first, no telemetry) and how Discord Rich Presence works.', group: 'Legal', order: 3 },
